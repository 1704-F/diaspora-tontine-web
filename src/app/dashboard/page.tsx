      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Choisissez le module que vous souhaitez utiliser pour gérer vos
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          {moduleCards.map((module) => {
            ...
            const isEnabled =
              user?.enabledModules?.[
                module.id as keyof typeof user.enabledModules
              ]?.enabled || false;
            ...
            return (
              <Card
                ...
                onClick={() =>
                  module.available && handleModuleSelect(module.id)
                }
              >
                <CardHeader className="pb-4">
                  <div className="flex items-center justify-between">
                    <div className={`p-4 rounded-xl ${module.colors.iconBg}`}>
                      <IconComponent
                        className={`h-8 w-8 ${module.colors.iconColor}`}
                      />
                    </div>
        ...
        <div className="mt-16 text-center">
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8 max-w-2xl mx-auto">
            ...
            <p className="text-gray-600 text-sm">
              Nous travaillons sur les modules <strong>Budget Famille</strong>{" "}
              et <strong>Commerce Diaspora</strong>
